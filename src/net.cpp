...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Creepercoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"tools.creepercoin.com", "dnsseed.creepercoin.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"test.tools.creepercoin.com", "test-dnsseed.creepercoin.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Creepercoin is probably already running."), addrBind.ToString().c_str());
        else
